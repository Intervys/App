          ...
          <div style="padding:1.5rem">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input class="form-control" id="ws-api-url" placeholder="https://app.Intervys.fr">
              </div>
            </div>
            <div class="form-group">
          ...
          <div style="padding:1.5rem">
            ...
            <details style="margin-top:.5rem">
              ...
              <div style="margin-top:.75rem;display:flex;gap:.5rem">
                <input class="form-control" id="upd-url" placeholder="https://Intervys.fr/Intervys/latest.json" style="flex:1;font-size:.83rem">
...
// URL publique de la vitrine (app.Intervys.fr → Intervys.fr ; sinon même origine)
...
async function loadUpdateTab() {
  try {
    ...
    if (urlEl) urlEl.value = map.app_update_url || 'https://Intervys.fr/Intervys/latest.json';
